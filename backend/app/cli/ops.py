...
用法:
    python -m app.cli.ops replay-task <task_id>
    python -m app.cli.ops mark-done <task_id> [--reason "手动完结"]
    python -m app.cli.ops requeue-dead-letter [--all] [--entry-id <id>]
    python -m app.cli.ops throttle --concurrency 1
    python -m app.cli.ops list-stalled [--threshold 300]
    python -m app.cli.ops task-info <task_id>
"""
