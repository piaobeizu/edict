...
STATE_AGENT_MAP = {
    ...
    TaskState.YuLan: "shangshu",       # 御览：尚书省汇总呈报
    TaskState.Assigned: "shangshu",    # 派发：尚书省分配六部
    TaskState.Doing: "shangshu",       # 执行：默认尚书省协调，可被 ORG_AGENT_MAP 覆盖
    TaskState.Review: "shangshu",      # 审查：尚书省汇总验收
}
