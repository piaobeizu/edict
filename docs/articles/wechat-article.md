...
![封面：军机处看板全貌](../media/screenshots/01-kanban-main.png)
...
![上朝仪式：每日首次打开的彩蛋动画](../media/screenshots/11-ceremony.png)
...
![官员总览](../media/screenshots/06-official-overview.png)
*▲ 官员总览：Token 消耗排行榜 + 活跃度统计*

![天下要闻](../media/screenshots/10-morning-briefing.png)
*▲ 天下要闻：每日自动聚合科技/财经资讯*
...
![任务流转详情](../media/screenshots/03-task-detail.png)
...
Compose 会自动拉起 v2 backend、worker、数据库和前端。

![技能配置](../media/screenshots/05-skills-config.png)
