"""edict-kernel — 与框架/存储无关的工作流引擎核心。

核心层零外部依赖（纯 stdlib），adapters 按需导入。

Quick start:
    from edict_kernel import StateMachine, TaskEntity, WorkflowEngine
    from edict_kernel.ports import TaskRepo, EventBusPort, AgentExecutor, RoutingPolicy
